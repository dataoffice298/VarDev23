pageextension 50109 AccountantActivities extends "Accountant Activities"
{
    layout
    {
        addafter("Purchase Documents Due Today")
        {
            ...
            field("BG Expiry Today"; Rec."BG Expiry Today")
            {
                ApplicationArea = all;
                Editable = false;

            }
            field("FDR Maturity Today"; Rec."FDR Maturity Today")
            {
                ApplicationArea = all;
                Editable = false;

            }
            field("TDS Liability for the Month"; Rec."TDS Liability for the Month")
            {
                ApplicationArea = all;
                Editable = false;
            }
