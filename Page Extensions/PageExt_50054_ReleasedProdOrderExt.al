pageextension 50054 "Released prod OrderExt" extends "Released Production Order"
{
    layout
    {
        ...
        modify("Shortcut Dimension 1 Code")
        {
            ...
            begin
                if CopyStr(Rec."Shortcut Dimension 1 Code", 1, 1) <> CopyStr(Rec."No. Series", 1, 1) then
    ...
    actions
    {
        ...
        modify(RefreshProductionOrder)
        {
            ...
            begin
                ...
                Rec.TestField("Shortcut Dimension 2 Code");
                Rec.TestField("Assigned User ID");
                if Rec."Subcontracting Order" then
                    Rec.TestField("Purchase Order No.");
                if (not Rec."Subcontracting Order") then begin
                    if (Rec."Shortcut Dimension 2 Code" <> 'D99-GEN') and (Rec."Shortcut Dimension 2 Code" <> 'E99-GEN') then begin
            ...
            action("Change Sales No")
            {
                ...
                begin
                    ...
                    if ProductionOrder.FindFirst() then begin
                        ProdOrderReport.GetValues(Rec."Shortcut Dimension 2 Code");
    ...
    begin
        ...
        InventorySetup.Get();
        ItemjnLine.Reset();
        ItemjnLine.SetRange("Document No.", Rec."No.");
