                    ...
                    IF CONFIRM(Text001, FALSE, 1) THEN BEGIN
                        if Rec."Rework Level" = 0 then begin
                            ...
                            if Selection = 1 then begin
                                ...
                                rec."Qty to send reworked" := Abs(rec."Qty to Receive Rework" - Rec."Qty to send reworked");
                                Rec."Qty to Receive Rework" := 0;
                                Rec.Modify();

                                Message('Accept successufully');
                            end else
