        ...
        area(content)
        {
            group(General)
            {
                ...
                field("No."; Rec."No.")
                {
                    ...
                    begin
                        if Rec.AssistEditMrs(xRec) then
                            CurrPage.Update();
                    end;
                }
                field("Transfer-from Code"; Rec."Transfer-from Code")
                {
                    ...
                    begin
                        if (Rec."Transfer-from Code" <> '') and ((Rec."Transfer-from Code" <> 'DOMSTORES') and (Rec."Transfer-from Code" <> 'EOUSTORES')) then
                            Error('From Location Should Be - DOMSTORES or EOUSTORES');
                        if CopyStr(Rec."Transfer-from Code", 1, 1) <> CopyStr(Rec."No. Series", 1, 1) then
                ...
                field("Transfer-to Code"; Rec."Transfer-to Code")
                {
                    ...
                    var
                        LocationLrec: Record Location;
                    begin
                        if CopyStr(Rec."Transfer-from Code", 1, 1) <> CopyStr(Rec."Transfer-to Code", 1, 1) then
                            Error('you cannot select this location');
                        IsTransferLinesEditable := Rec.TransferLinesEditable();
                        CurrPage.Update();
                    end;
                ...
                field("Direct Transfer"; Rec."Direct Transfer")
                {
                    ...
                    trigger OnValidate()
                    begin
                        if (Rec."Transfer-from Code" <> '') and (Rec."Transfer-to Code" <> '') then
                            if CopyStr(Rec."Transfer-from Code", 1, 1) <> CopyStr(Rec."Transfer-to Code", 1, 1) then
                                error('You cannot select this location');
                        IsTransferLinesEditable := Rec.TransferLinesEditable();
                        CurrPage.Update();
